...
// --- MIDDLEWARES ---
app.use(cors({
  origin: true, // Libera qualquer origem para testes
  credentials: true
}));
...
// --- Caminhos dos CSVs ---
const USERS_CSV_PATH = path.join(__dirname, 'user.csv');
const PRODUCTS_CSV_PATH = path.join(__dirname, 'product.csv');
